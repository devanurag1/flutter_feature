...
//   // Method to save image to device
//   Future<String> _saveImage(Uint8List imageBytes) async {
//     try {
//       final directory = await getTemporaryDirectory();
//       final String path = '${directory.path}/share_image_${DateTime.now().millisecondsSinceEpoch}.png';
...
//     try {
//       const String textToShare = 'Check out this awesome app! https://example.com';
